...
import { normalizeColorIdentity, getColorIdentity, COLOR_MAPPINGS } from '@/lib/utility/color-identity';
            ...
            <CardContent className="pt-6 text-center space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  Thank you for your custom Commander deck submission. We'll get started on your deck soon!
                </p>
              </div>
          ...
          <CardContent className="pt-8 space-y-8">
            ...
            <div className="flex gap-4 pt-6">
              <Button
                ...
                className="flex-1 bg-gradient-to-r from-[var(--gradient-start)] via-[var(--gradient-mid)] to-[var(--gradient-end)] hover:opacity-90 transition-opacity text-white font-semibold h-12"
              >
                Submit
              </Button>
              <Button
                onClick={handleClear}
                variant="outline"
                className="px-8 h-12 border-tinted hover:bg-accent-tinted"
              >
                Clear form
              </Button>
            </div>
