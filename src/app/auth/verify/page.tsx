...
function VerifyContent() {
  ...
  useEffect(() => {
    const verifyToken = async () => {
      ...
      try {
        ...
        console.log('Attempting to verify OTP with:', { type, tokenHash: tokenHash.substring(0, 10) + '...' });
  ...
  <>
  <ShineBorder
    borderWidth={2} duration={160} shineColor={"linear-gradient(var(--some-color)0%, var(--some-color)35%, var(--some-color)70%, var(--some-color)100%)"}
