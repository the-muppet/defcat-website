 ...
 */
export function normalizeColorIdentity(colorIdentity: string | string[]): string {
  const order = 'WUBRGC'
...
/**
 * Get color identity mapping (guild/clan/etc)
 */
export function getColorIdentity(colorIdentity: string | string[]): ColorMapping | null {
